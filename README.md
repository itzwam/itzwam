...
- [nix-community/lanzaboote](https://github.com/nix-community/lanzaboote) ([v0.4.3](https://github.com/nix-community/lanzaboote/releases/tag/v0.4.3), 2 days ago) - Secure Boot for NixOS [maintainers=@blitz @raitobezarius @nikstur]
