...
- [nix-community/lanzaboote](https://github.com/nix-community/lanzaboote) ([v1.0.0](https://github.com/nix-community/lanzaboote/releases/tag/v1.0.0), 2 days ago) - Secure Boot for NixOS [maintainers=@blitz @raitobezarius @nikstur]
